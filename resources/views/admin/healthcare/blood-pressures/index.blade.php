                        ...
                        <tr data-entry-id="{{ $bloodPressure->id }}">
                            ...
                            <td>
                                ...
                                @can('blood_pressure_delete')
                                    <form action="{{ route('admin.healthcare.blood-pressures.destroy', $bloodPressure->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.are_you_sure') }}');" style="display: inline-block;">
